...
<body>
	...
	if($_POST){
		...
		mysqli_query($conexion,"INSERT INTO pregunta (cod_preg,enunciado) VALUES (NULL,'".$_POST['res']."')") or die ("Fallo Introducir datos a tabla");
	}
	?>
	<form method="post" action="IntrPreg.php">
	Enviar Pregunta: <input type="text" name="res" required>
	</form>
</body>
</html>